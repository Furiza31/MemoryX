export default {
  ...
  'savingsMadePerMonth': 'Économies réalisées par mois',
  'savingsMadePerYear': 'Économies réalisées par an',
  'totalMoneyPerMonth': 'Argent total par mois',
  'totalMoneyPerYear': 'Argent total par an',
  'moneyNotUsed': 'Argent non utilisé',
