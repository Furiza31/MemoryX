export default {
  ...
  'savingsMadePerMonth': 'Savings made per month',
  'savingsMadePerYear': 'Savings made per year',
  'totalMoneyPerMonth': 'Total money per month',
  'totalMoneyPerYear': 'Total money per year',
  'moneyNotUsed': 'Money not used',
  'newSection': 'New section',
  'sectionName': 'Section name',
  'unexpected': 'Unexpected',
  'fitness': 'Fitness',
  'fitnessCaption': 'Manage your workouts',
}
